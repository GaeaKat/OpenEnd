...
public class ComponentEndVillageChurch extends ComponentEndVillage
{
    public ComponentEndVillageChurch() {}

    public ComponentEndVillageChurch(ComponentEndVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static ComponentEndVillageChurch func_74919_a(ComponentEndVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new ComponentEndVillageChurch(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
    }
