...
public class ComponentEndVillageTorch extends ComponentEndVillage
{
    public ComponentEndVillageTorch() {}

    public ComponentEndVillageTorch(ComponentEndVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static StructureBoundingBox func_74904_a(ComponentEndVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6)
    {
