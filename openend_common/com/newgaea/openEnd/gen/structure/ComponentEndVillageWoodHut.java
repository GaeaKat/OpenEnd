...
public class ComponentEndVillageWoodHut extends ComponentEndVillage
{
    private boolean isTallHouse;
    private int tablePosition;

    public ComponentEndVillageWoodHut() {}

    public ComponentEndVillageWoodHut(ComponentEndVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static ComponentEndVillageWoodHut func_74908_a(ComponentEndVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new ComponentEndVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
    }
