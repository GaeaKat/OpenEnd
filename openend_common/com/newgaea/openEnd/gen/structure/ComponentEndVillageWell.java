...
public class ComponentEndVillageWell extends ComponentEndVillage
{
    public ComponentEndVillageWell() {}

    public ComponentEndVillageWell(ComponentEndVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, int par4, int par5)
    {
