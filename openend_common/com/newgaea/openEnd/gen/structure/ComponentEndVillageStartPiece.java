...
public class ComponentEndVillageStartPiece extends ComponentEndVillageSpire
{
    ...
    public StructureEndVillagePieceWeight structVillagePieceWeight;
    ...
    public ComponentEndVillageStartPiece() {}

    public ComponentEndVillageStartPiece(WorldChunkManager par1WorldChunkManager, int par2, Random par3Random, int par4, int par5, List par6List, int par7)
    {
        super((ComponentEndVillageStartPiece)null, 0, par3Random, par4, par5);
