...
public class ComponentEndVillageHouse4_Garden extends ComponentEndVillage
{
    private boolean isRoofAccessible;

    public ComponentEndVillageHouse4_Garden() {}

    public ComponentEndVillageHouse4_Garden(ComponentEndVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static ComponentEndVillageHouse4_Garden func_74912_a(ComponentEndVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        return StructureComponent.findIntersecting(par1List, structureboundingbox) != null ? null : new ComponentEndVillageHouse4_Garden(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6);
    }
