...
public class WorldGenEndMinable extends WorldGenerator
{
    ...
    public WorldGenEndMinable(int par1, int par2, int par3)
    {
    ...
    public WorldGenEndMinable(int id, int meta, int number, int target)
    {
                    ...
                    for (int l2 = j1; l2 <= i2; ++l2)
                    {
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D)
                        {
                            for (int i3 = k1; i3 <= j2; ++i3)
                            {
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && (block != null && block.blockID==Block.whiteStone.blockID))
                                {
